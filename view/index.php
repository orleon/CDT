                ...
                <div class="col-sm-3" id="box-vertical-megamenus">
                    ...
                    <div class="vertical-menu-content is-home">
                        <ul class="vertical-menu-list">
                            <li><a href="category.html"><img class="icon-menu" alt="Funky roots" src="../public/data/12.png">Electronics</a></li>
                            <li>
                                <a class="parent" href="category2.html"><img class="icon-menu" alt="Funky roots" src="../public/data/13.png">Sports &amp; Outdoors</a>
                            ...
                            <li><a href="category.html"><img class="icon-menu" alt="Funky roots" src="../public/data/14.png">Smartphone &amp; Tablets</a></li>
                            <li><a href="category.html"><img class="icon-menu" alt="Funky roots" src="../public/data/15.png">Health &amp; Beauty Bags</a></li>
                            <li>
                                <a class="parent" href="category.html">
                                <img class="icon-menu" alt="Funky roots" src="../public/data/16.png">Shoes &amp; Accessories</a>
                                <div class="vertical-dropdown-menu">
                                        <div class="vertical-groups col-sm-12">
                            ...
                            <li><a href="category.html"><img class="icon-menu" alt="Funky roots" src="../public/data/17.png">Toys &amp; Hobbies</a></li>
                            <li><a href="category.html"><img class="icon-menu" alt="Funky roots" src="../public/data/18.png">Computers &amp; Networking</a></li>
                            <li><a href="category.html"><img class="icon-menu" alt="Funky roots" src="../public/data/19.png">Laptops &amp; Accessories</a></li>
                            <li><a href="category.html"><img class="icon-menu" alt="Funky roots" src="../public/data/20.png">Jewelry &amp; Watches</a></li>
                            <li><a href="category.html"><img class="icon-menu" alt="Funky roots" src="../public/data/21.png">Flashlights &amp; Lamps</a></li>
                            <li>
                                <a href="category.html">
                                    <img class="icon-menu" alt="Funky roots" src="../public/data/21.png">
                                    Cameras &amp; Photo
                                </a>
                            </li>
                            <li class="cat-link-orther">
                                <a href="category.html">
                                    <img class="icon-menu" alt="Funky roots" src="../public/data/22.png">
                                    Television
                                </a>
                            </li>
                            <li class="cat-link-orther">
                                <a href="category.html">
                                    <img class="icon-menu" alt="Funky roots" src="../public/data/12.png">Computers &amp; Networking
                                </a>
                            </li>
                            <li class="cat-link-orther">
                                <a href="category.html">
                                    <img class="icon-menu" alt="Funky roots" src="../public/data/14.png">
                                    Toys &amp; Hobbies
                                </a>
                            </li>
                            <li class="cat-link-orther">
                            <a href="category.html"><img class="icon-menu" alt="Funky roots" src="../public/data/17.png">Jewelry &amp; Watches</a></li>
                        </ul>
